...
export default function Cloudarchitect() {
  ...
  const CloudarchitectDeveloper: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 22);
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {CloudarchitectDeveloper && (
          <>
            <ColorfulCard
              title={CloudarchitectDeveloper.name || "Cloudarchitect Developer"}
              content={
                <p className="text-lg text-gray-700">
                  {CloudarchitectDeveloper.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.responsibilities.map(
            ...
            <ColorfulCard
              ...
              content={
                <p className="text-lg text-gray-700">
                  {CloudarchitectDeveloper.salaryRange}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {CloudarchitectDeveloper.careerProgression.map(
                    (progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.certifications.map(
                    (certification, index) => (
                      <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper.commonInterviewQuestions.map(
                    (question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {CloudarchitectDeveloper?.resourcesForLearning.map(
                    (resource, index) => {
