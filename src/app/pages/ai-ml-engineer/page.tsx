...
export default function Aimlengineer() {
  ...
  const AimlengineerDeveloper: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 8);
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {AimlengineerDeveloper && (
          <>
            <ColorfulCard
              title={AimlengineerDeveloper.name || "Aimlengineer Developer"}
              content={
                <p className="text-lg text-gray-700">
                  {AimlengineerDeveloper.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.responsibilities.map(
            ...
            <ColorfulCard
              ...
              content={
                <p className="text-lg text-gray-700">
                  {AimlengineerDeveloper.salaryRange}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {AimlengineerDeveloper.careerProgression.map(
                    (progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.certifications.map(
                    (certification, index) => (
                      <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper.commonInterviewQuestions.map(
                    (question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {AimlengineerDeveloper?.resourcesForLearning.map(
                    (resource, index) => {
