...
export default function Se() {
  ...
  const SeDeveloper: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 14);
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {SeDeveloper && (
          <>
            <ColorfulCard
              title={SeDeveloper.name || "Se Developer"}
              content={
                <p className="text-lg text-gray-700">
                  {SeDeveloper.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.responsibilities.map(
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {SeDeveloper.careerProgression.map(
                    (progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.certifications.map(
                    (certification, index) => (
                      <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper.commonInterviewQuestions.map(
                    (question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {SeDeveloper?.resourcesForLearning.map(
                    (resource, index) => {
