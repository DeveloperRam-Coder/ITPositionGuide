...
export default function Backend() {
  ...
  const BackendDeveloper: Position | undefined = transformedPositions.find(
    (position: Position) => position.id === 2
  );
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {BackendDeveloper && (
          <>
            <ColorfulCard
              title={BackendDeveloper.name || "Backend Developer"}
              content={
                <p className="text-lg text-gray-700">
                  {BackendDeveloper.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.responsibilities.map(
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {BackendDeveloper.careerProgression.map(
                    (progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.certifications.map(
                    (certification, index) => (
                      <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper.commonInterviewQuestions.map(
                    (question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {BackendDeveloper?.resourcesForLearning.map(
                    (resource, index) => {
