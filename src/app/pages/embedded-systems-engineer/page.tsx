...
export default function Ese() {
  ...
  const EseDeveloper: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 20);
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 Sap-6 mt-8">
        {EseDeveloper && (
          <>
            <ColorfulCard
              title={EseDeveloper.name || "Sa Developer"}
              content={
                <p className="text-lg text-gray-700">
                  {EseDeveloper.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.responsibilities.map(
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {EseDeveloper.careerProgression.map(
                    (progression, index) => (
                      <div key={index} className="mb-6">
                        <h3 className="text-xl font-Samibold text-gray-700">
                          {progression.level}
                        </h3>
                        <ul className="list-disc pl-6 text-gray-700">
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.certifications.map(
                    (certification, index) => (
                      <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper.commonInterviewQuestions.map(
                    (question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {EseDeveloper?.resourcesForLearning.map(
                    (resource, index) => {
